...
@Entity
public class Ligne_Frais_Hors_Forfait implements Serializable{
    ...
    public Ligne_Frais_Hors_Forfait() {
        super();
    }


    public Ligne_Frais_Hors_Forfait(Long id, Visiteur visiteur_id, int mois, String libelle, Date date, float montant) {
        this.id = id;
